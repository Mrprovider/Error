...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "TG_LINKS_CHANNEL")
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/9b13ea3ce046a1a5c8098.png")
admins = {}
API_ID = int(getenv("API_ID"))
API_HASH = getenv("API_HASH")
BOT_USERNAME = getenv("BOT_USERNAME")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Kannada_admins")
OWNER_NAME = getenv("OWNER_NAME", "HEROGAMERS1")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "TG_UPDATES1")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5732833763").split()))
